      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3">
            <h3 className="font-heading text-sm font-semibold uppercase tracking-wider text-brand-navy">Newsletter</h3>
            <p className="mt-4 text-sm text-muted-foreground">Insights on AI, engineering, and product development.</p>
            <form className="mt-4 flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                type="email"
                placeholder="you@company.com"
                aria-label="Email for newsletter"
                className="flex-1 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-brand-navy placeholder:text-muted-foreground outline-none transition-colors focus:border-brand-blue/50"
              />
              <button
                type="submit"
